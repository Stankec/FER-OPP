...
;(function(factory) {
  ...
  NProgress.render = function(fromStart) {
    ...
    if (!Settings.showSpinner)
  	...
  	if (!(Settings.attachedTo === '')) {
  		if (Settings.attachedHow.toLowerCase() == "before") { // Before
  			$el.prependTo($(Settings.attachedTo));
  		} else { // After
  			$el.appendTo($(Settings.attachedTo));
  		};
  		$el.find('[role="bar"]').css({
		  	position: "relative"
		});
...
//= requiree ckeditor/init

//= requiree nprogress
//= requiree nprogress-turbolinks
